<div align="left">
  ...
  <a href="./README_zh-TW.md"><img src="https://img.shields.io/badge/lang-zh--TW-lightgrey.svg" alt="Traditional Chinese"></a>
</div>
...
1. Query Rewriting (optional, controlled by `ENHANCE_QUERY`): rewrite the user query via an Ollama `/api/chat` endpoint to improve semantic retrieval. For instance, a simple query like "Search for patients with active HIV encephalopathy." is transformed into a comprehensive, expert-level query like "Brain MRI report findings consistent with HIV encephalopathy or opportunistic infections in HIV-positive patients, including findings such as white matter hyperintensities, basal ganglia lesions, cortical atrophy, or evidence of toxoplasmosis, cryptococcoma, or progressive multifocal leukoencephalopathy (PML)."
